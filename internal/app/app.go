...
func createGatewayInboundMessageProcessor(app *App, logger *slog.Logger) (*messages.Processor[inbound.EventsVisitor], error) {
    ...
    eventsVisitor := inbound.NewEventsVisitorImpl(paymentsClient, logger)
    return messages.NewProcessor[inbound.EventsVisitor](
...
func createGatewayMessageProcessor(app *App, logger *slog.Logger) (*messages.Processor[outbound.EventsVisitor], error) {
    ...
    eventsVisitor := outbound.NewEventsVisitorImpl(eventsDB, paymentsClient, logger)
    return messages.NewProcessor[outbound.EventsVisitor](
            esdbMessagesConsumer,
