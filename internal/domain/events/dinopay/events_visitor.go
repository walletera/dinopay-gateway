...
func NewEventsVisitorImpl(db events.DB, paymentsApiClient *api.Client, logger *slog.Logger) *EventsVisitorImpl {
...
func (ev EventsVisitorImpl) VisitPaymentCreated(ctx context.Context, event PaymentCreated) procerrors.ProcessingError {
