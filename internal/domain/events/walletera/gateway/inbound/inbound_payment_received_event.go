...
var _ events.Event[EventsVisitor] = PaymentReceived{}
...
func (i PaymentReceived) Accept(ctx context.Context, visitor EventsVisitor) errors.ProcessingError {
    return visitor.VisitInboundPaymentReceived(ctx, i)
}
